...
function useIceServers(config) {
    ...
    var _f = useState(), iceServers = _f[0], setIceServers = _f[1];
    useEffect(function () {
        if (!channelEndpoint) {
            return;
        }
...
function useSignalingClient(config) {
    ...
    var _e = useState(), signalingClient = _e[0], setSignalingClient = _e[1];
    var _f = useState(), signalingClientError = _f[0], setSignalingClientError = _f[1];
